...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190908-donors">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190908-donors/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190908-donors/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190908-donors/",
      "url": "http://static.startribune.com/news/projects/all/20190908-donors/"
    }
  }
}
```
